...
class ProductTypesControllerTest < ActionController::TestCase
  ...
  test "should create product_type" do
    assert_difference('ProductType.count') do
      post :create, product_type: { description: @product_type.description, name: @product_type.name, type_image: @product_type.type_image }
    end
  ...
  test "should update product_type" do
    patch :update, id: @product_type, product_type: { description: @product_type.description, name: @product_type.name, type_image: @product_type.type_image }
    assert_redirected_to product_type_path(assigns(:product_type))
  end
